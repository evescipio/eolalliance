...
angular.module("angularcountdown.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("angularcountdown.html",
    "<div id=\"countdown\" ng-if=\"timespan\">\n" +
...
angular.module('angular-countdown').directive('countdown', ['$interval', function($interval) {
    ...
    return {
        ...
        templateUrl: function(element, attributes) {
          return 'angularcountdown.html';
        },
        link: function($scope) {

            var time = new Date($scope.stopdate).getTime();

            $interval(function(){
            $scope.timespan = countdown(null, time, countdown.DAYS|countdown.HOURS|countdown.MINUTES|countdown.SECONDS, 5);
            angular.element('#days').html($scope.timespan.days.toString());
            angular.element('#hours').html($scope.timespan.hours.toString());
            angular.element('#minutes').html($scope.timespan.minutes.toString());
            angular.element('#seconds').html($scope.timespan.seconds.toString());
            }, 1000);
        }
    };
}]);